  ...
  return (
    <>
      <div className="flex flex-col gap-4 w-full max-w-7xl mx-auto px-4 sm:px-6 md:px-0 ">
        <div className="flex flex-col sm:flex-row gap-2 text-4xl font-semibold leading-tight sm:leading-[69.19px] text-center sm:text-left relative ">
        ...
        <div className="text-[#5C6C68] text-xl sm:text-2xl font-bold leading-relaxed text-center sm:text-left ">
